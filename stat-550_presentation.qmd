...
-  Confidence interval + false positive risk [@BlumeGreevyWelty:2019]. 
-  Second generation p-values [@BlumeGreevyWelty:2019]. 
-  Second generation p-values [@BlumeGreevyWelty:2019]. 

## Conclusion

Here are some important recommendations to keep in mind with regards to scientific research:

- Avoid making scientific conclusions or policy decisions based solely on P-values [@Baker:2016].
- You should weigh the evidence properly before drawing any conclusions.
- P-values alone are not enough to determine the truth or importance of research findings.
- It's crucial to ensure transparent reporting and rigorous analysis of scientific research.
- We should question whether the absence of evidence is a valid justification for inaction [@AltmanBland:1995].
- Always consider other factors of the study such as sample size.
