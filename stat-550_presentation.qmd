...
-   He intended it simply as an informal way to judge whether worthy of a second look.
- **Idea:** see if the results were consistent with what random chance might produce.
:::

::: {.column width="40%"}

![](https://upload.wikimedia.org/wikipedia/commons/a/aa/Youngronaldfisher2.JPG){.absolute top=100 left=800 width="350"}
